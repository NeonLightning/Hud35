...
# Setup systemd service using virtual environment
...
# Interactive configuration menu - Walk through all settings
config:
	@echo "$(BLUE)=========================================$(NC)"
...
# Configure button GPIO settings
config-buttons:
...
# Create default configuration file (internal target)
